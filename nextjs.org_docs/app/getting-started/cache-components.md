...
### [During prerendering](#during-prerendering)
...
### [With runtime data](#with-runtime-data)
...
#### [With `revalidateTag`](#with-revalidatetag)
...
## [Navigation uses Activity](#navigation-uses-activity)
...
## [Migrating route segment configs](#migrating-route-segment-configs)
