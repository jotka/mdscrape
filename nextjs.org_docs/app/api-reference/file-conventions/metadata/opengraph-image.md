...
RouteURL`params``app/shop/opengraph-image.js``/shop``undefined``app/shop/[slug]/opengraph-image.js``/shop/1``Promise<{ slug: '1' }>``app/shop/[tag]/[item]/opengraph-image.js``/shop/1/2``Promise<{ tag: '1', item: '2' }>`
...
VersionChanges`v16.0.0``params` is now a promise that resolves to an object`v13.3.0``opengraph-image` and `twitter-image` introduced.
