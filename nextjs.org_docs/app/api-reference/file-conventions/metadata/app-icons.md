...
RouteURL`params``app/shop/icon.js``/shop``undefined``app/shop/[slug]/icon.js``/shop/1``Promise<{ slug: '1' }>``app/shop/[tag]/[item]/icon.js``/shop/1/2``Promise<{ tag: '1', item: '2' }>`
...
VersionChanges`v16.0.0``params` is now a promise that resolves to an object`v13.3.0``favicon` `icon` and `apple-icon` introduced
