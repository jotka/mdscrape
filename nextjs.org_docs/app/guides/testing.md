...
[**Cypress**  
\
Learn how to set up Cypress with Next.js for End-to-End (E2E) and Component Testing.](/docs/app/guides/testing/cypress)

[**Jest**  
\
Learn how to set up Jest with Next.js for Unit Testing and Snapshot Testing.](/docs/app/guides/testing/jest)

[**Playwright**  
\
Learn how to set up Playwright with Next.js for End-to-End (E2E) Testing.](/docs/app/guides/testing/playwright)

[**Vitest**  
\
Learn how to set up Vitest with Next.js for Unit Testing.](/docs/app/guides/testing/vitest)
