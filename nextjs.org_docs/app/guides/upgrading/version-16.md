...
RequirementChange / DetailsNode.js 20.9+Minimum version now `20.9.0` (LTS); Node.js 18 no longer supportedTypeScript 5+Minimum version now `5.1.0`BrowsersChrome 111+, Edge 111+, Firefox 111+, Safari 16.4+
...
### [Migrating types for async Dynamic APIs](#migrating-types-for-async-dynamic-apis)
