...
source: "https://nextjs.org/docs/15/app/guides/css-in-js"
---
...
[App Router](/docs/15/app)[Guides](/docs/15/app/guides)CSS-in-JS
...
- [`@fluentui/react-components`](https://react.fluentui.dev/?path=%2Fdocs%2Fconcepts-developer-server-side-rendering-next-js-appdir-setup--page)
...
> - For advanced use cases where you need to configure individual properties of styled-components compilation, you can read our [Next.js styled-components API reference](/docs/15/architecture/nextjs-compiler#styled-components) to learn more.
