...
source: "https://nextjs.org/docs/15/app/guides/content-security-policy"
---
...
[App Router](/docs/15/app)[Guides](/docs/15/app/guides)Content Security Policy
...
VersionChanges`v14.0.0`Experimental SRI support added for hash-based CSP`v13.4.20`Recommended for proper nonce handling and CSP header parsing.
...
**headers**  
\
API reference for the headers function.](/docs/15/app/api-reference/functions/headers)
