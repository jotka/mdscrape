...
source: "https://nextjs.org/docs/15/app/guides/draft-mode"
---
...
[App Router](/docs/15/app)[Guides](/docs/15/app/guides)Draft Mode
...
**draftMode**  
\
API Reference for the draftMode function.](/docs/15/app/api-reference/functions/draft-mode)
