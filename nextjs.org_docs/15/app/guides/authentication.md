...
source: "https://nextjs.org/docs/15/app/guides/authentication"
---
...
[App Router](/docs/15/app)[Guides](/docs/15/app/guides)Authentication
...
Using context providers for auth works due to [interleaving](/docs/15/app/getting-started/server-and-client-components#examples%23interleaving-server-and-client-components). However, React `context` is not supported in Server Components, making them only applicable to Client Components.
