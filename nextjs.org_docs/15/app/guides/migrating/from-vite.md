...
source: "https://nextjs.org/docs/15/app/guides/migrating/from-vite"
---
...
[Guides](/docs/15/app/guides)[Migrating](/docs/15/app/guides/migrating)Vite
...
Create a `next.config.mjs` at the root of your project. This file will hold your [Next.js configuration options](/docs/15/app/api-reference/config/next-config-js).
...
You can find more information about configuring TypeScript on the [Next.js docs](/docs/15/app/api-reference/config/typescript#ide-plugin).

### [Step 4: Create the Root Layout](#step-4-create-the-root-layout)

A Next.js [App Router](/docs/15/app) application must include a [root layout](/docs/15/app/api-reference/file-conventions/layout#root-layout) file, which is a [React Server Component](/docs/15/app/getting-started/server-and-client-components) that will wrap all pages in your application. This file is defined at the top level of the `app` directory.
...
6. Finally, Next.js can manage your last `<head>` tags with the [Metadata API](/docs/15/app/getting-started/metadata-and-og-images). Move your final metadata info into an exported [`metadata` object](/docs/15/app/api-reference/functions/generate-metadata#metadata-object):
...
This file is a [Server Component](/docs/15/app/getting-started/server-and-client-components). When you run `next build`, the file is prerendered into a static asset. It does *not* require any dynamic code.
...
This file is a [Client Component](/docs/15/app/getting-started/server-and-client-components), defined by the `'use client'` directive. Client Components are still [prerendered to HTML](/docs/15/app/getting-started/server-and-client-components#how-do-server-and-client-components-work-in-nextjs) on the server before being sent to the client.
...
Next.js has support for `.env` [environment variables](/docs/15/app/guides/environment-variables) similar to Vite. The main difference is the prefix used to expose environment variables on the client-side.
