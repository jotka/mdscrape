---
title: "Prefetching"
source: "https://nextjs.org/docs/15/app/guides/prefetching"
---
...
[App Router](/docs/15/app)[Guides](/docs/15/app/guides)Prefetching
...
**Static page****Dynamic page****Prefetched**Yes, full routeNo, unless [`loading.js`](/docs/15/app/api-reference/file-conventions/loading)[**Client Cache TTL**](/docs/15/app/guides/caching#full-route-cache)5 min (default)Off, unless [enabled](/docs/15/app/api-reference/config/next-config-js/staleTimes)**Server roundtrip on click**NoYes, streamed after [shell](/docs/15/app/getting-started/partial-prerendering#how-does-partial-prerendering-work)
...
**Context****Prefetched payload****Client Cache TTL**No `loading.js`Entire pageUntil app reloadWith `loading.js`Layout to first loading boundary30s ([configurable](/docs/15/app/api-reference/config/next-config-js/staleTimes))
