...
source: "https://nextjs.org/docs/15/app/getting-started/metadata-and-og-images"
---
...
[App Router](/docs/15/app)[Getting Started](/docs/15/app/getting-started)Metadata and OG images
...
**generateMetadata**  
\
Learn how to add Metadata to your Next.js application for improved search engine optimization (SEO) and web shareability.](/docs/15/app/api-reference/functions/generate-metadata)
...
**ImageResponse**  
\
API Reference for the ImageResponse constructor.](/docs/15/app/api-reference/functions/image-response)
...
**htmlLimitedBots**  
\
Specify a list of user agents that should receive blocking metadata.](/docs/15/app/api-reference/config/next-config-js/htmlLimitedBots)
