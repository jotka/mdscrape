---
title: "CSS"
source: "https://nextjs.org/docs/15/app/getting-started/css"
---
...
[App Router](/docs/15/app)[Getting Started](/docs/15/app/getting-started)CSS
...
- In development (`next dev`), CSS updates apply instantly with [Fast Refresh](/docs/15/architecture/fast-refresh).
