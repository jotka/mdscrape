---
title: "Fetching Data"
source: "https://nextjs.org/docs/15/app/getting-started/fetching-data"
---
...
[App Router](/docs/15/app)[Getting Started](/docs/15/app/getting-started)Fetching Data
...
## [Deduplicate requests and cache data](#deduplicate-requests-and-cache-data)
...
**loading.js**  
\
API reference for the loading.js file.](/docs/15/app/api-reference/file-conventions/loading)
...
**logging**  
\
Configure how data fetches are logged to the console when running Next.js in development mode.](/docs/15/app/api-reference/config/next-config-js/logging)
...
**taint**  
\
Enable tainting Objects and Values.](/docs/15/app/api-reference/config/next-config-js/taint)
