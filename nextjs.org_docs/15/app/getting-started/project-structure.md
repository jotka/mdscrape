...
source: "https://nextjs.org/docs/15/app/getting-started/project-structure"
---
...
[App Router](/docs/15/app)[Getting Started](/docs/15/app/getting-started)Project Structure
...
[`app`](/docs/15/app)App Router[`pages`](/docs/15/pages/building-your-application/routing)Pages Router[`public`](/docs/15/app/api-reference/file-conventions/public-folder)Static assets to be served[`src`](/docs/15/app/api-reference/file-conventions/src-folder)Optional application source folder

### [Top-level files](#top-level-files)

Top-level files are used to configure your application, manage dependencies, run middleware, integrate monitoring tools, and define environment variables.

**Next.js**[`next.config.js`](/docs/15/app/api-reference/config/next-config-js)Configuration file for Next.js[`package.json`](/docs/15/app/getting-started/installation#manual-installation)Project dependencies and scripts[`instrumentation.ts`](/docs/15/app/guides/instrumentation)OpenTelemetry and Instrumentation file[`middleware.ts`](/docs/15/app/api-reference/file-conventions/middleware)Next.js request middleware[`.env`](/docs/15/app/guides/environment-variables)Environment variables[`.env.local`](/docs/15/app/guides/environment-variables)Local environment variables[`.env.production`](/docs/15/app/guides/environment-variables)Production environment variables[`.env.development`](/docs/15/app/guides/environment-variables)Development environment variables[`.eslintrc.json`](/docs/15/app/api-reference/config/eslint)Configuration file for ESLint`.gitignore`Git files and folders to ignore`next-env.d.ts`TypeScript declaration file for Next.js`tsconfig.json`Configuration file for TypeScript`jsconfig.json`Configuration file for JavaScript
...
[`layout`](/docs/15/app/api-reference/file-conventions/layout)`.js` `.jsx` `.tsx`Layout[`page`](/docs/15/app/api-reference/file-conventions/page)`.js` `.jsx` `.tsx`Page[`loading`](/docs/15/app/api-reference/file-conventions/loading)`.js` `.jsx` `.tsx`Loading UI[`not-found`](/docs/15/app/api-reference/file-conventions/not-found)`.js` `.jsx` `.tsx`Not found UI[`error`](/docs/15/app/api-reference/file-conventions/error)`.js` `.jsx` `.tsx`Error UI[`global-error`](/docs/15/app/api-reference/file-conventions/error#global-error)`.js` `.jsx` `.tsx`Global error UI[`route`](/docs/15/app/api-reference/file-conventions/route)`.js` `.ts`API endpoint[`template`](/docs/15/app/api-reference/file-conventions/template)`.js` `.jsx` `.tsx`Re-rendered layout[`default`](/docs/15/app/api-reference/file-conventions/default)`.js` `.jsx` `.tsx`Parallel route fallback page

### [Nested routes](#nested-routes)

Folders define URL segments. Nesting folders nests segments. Layouts at any level wrap their child segments. A route becomes public when a `page` or `route` file exists.

PathURL patternNotes`app/layout.tsx`—Root layout wraps all routes`app/blog/layout.tsx`—Wraps `/blog` and descendants`app/page.tsx``/`Public route`app/blog/page.tsx``/blog`Public route`app/blog/authors/page.tsx``/blog/authors`Public route
...
PathURL pattern`app/blog/[slug]/page.tsx``/blog/my-first-post``app/shop/[...slug]/page.tsx``/shop/clothing`, `/shop/clothing/shirts``app/docs/[[...slug]]/page.tsx``/docs`, `/docs/layouts-and-pages`, `/docs/api-reference/use-router`
...
PathURL patternNotes`app/(marketing)/page.tsx``/`Group omitted from URL`app/(shop)/cart/page.tsx``/cart`Share layouts within `(shop)``app/blog/_components/Post.tsx`—Not routable; safe place for UI utilities`app/blog/_lib/data.ts`—Not routable; safe place for utils
...
Pattern (docs)MeaningTypical use case[`@folder`](/docs/15/app/api-reference/file-conventions/parallel-routes#slots)Named slotSidebar + main content[`(.)folder`](/docs/15/app/api-reference/file-conventions/intercepting-routes#convention)Intercept same levelPreview sibling route in a modal[`(..)folder`](/docs/15/app/api-reference/file-conventions/intercepting-routes#convention)Intercept parentOpen parent child as overlay[`(..)(..)folder`](/docs/15/app/api-reference/file-conventions/intercepting-routes#convention)Intercept two levelsDeeply nested overlay[`(...)folder`](/docs/15/app/api-reference/file-conventions/intercepting-routes#convention)Intercept from rootShow arbitrary route in current view

### [Metadata file conventions](#metadata-file-conventions)

#### [App icons](#app-icons)

[`favicon`](/docs/15/app/api-reference/file-conventions/metadata/app-icons#favicon)`.ico`Favicon file[`icon`](/docs/15/app/api-reference/file-conventions/metadata/app-icons#icon)`.ico` `.jpg` `.jpeg` `.png` `.svg`App Icon file[`icon`](/docs/15/app/api-reference/file-conventions/metadata/app-icons#generate-icons-using-code-js-ts-tsx)`.js` `.ts` `.tsx`Generated App Icon[`apple-icon`](/docs/15/app/api-reference/file-conventions/metadata/app-icons#apple-icon)`.jpg` `.jpeg`, `.png`Apple App Icon file[`apple-icon`](/docs/15/app/api-reference/file-conventions/metadata/app-icons#generate-icons-using-code-js-ts-tsx)`.js` `.ts` `.tsx`Generated Apple App Icon

#### [Open Graph and Twitter images](#open-graph-and-twitter-images)

[`opengraph-image`](/docs/15/app/api-reference/file-conventions/metadata/opengraph-image#opengraph-image)`.jpg` `.jpeg` `.png` `.gif`Open Graph image file[`opengraph-image`](/docs/15/app/api-reference/file-conventions/metadata/opengraph-image#generate-images-using-code-js-ts-tsx)`.js` `.ts` `.tsx`Generated Open Graph image[`twitter-image`](/docs/15/app/api-reference/file-conventions/metadata/opengraph-image#twitter-image)`.jpg` `.jpeg` `.png` `.gif`Twitter image file[`twitter-image`](/docs/15/app/api-reference/file-conventions/metadata/opengraph-image#generate-images-using-code-js-ts-tsx)`.js` `.ts` `.tsx`Generated Twitter image

#### [SEO](#seo)

[`sitemap`](/docs/15/app/api-reference/file-conventions/metadata/sitemap#sitemap-files-xml)`.xml`Sitemap file[`sitemap`](/docs/15/app/api-reference/file-conventions/metadata/sitemap#generating-a-sitemap-using-code-js-ts)`.js` `.ts`Generated Sitemap[`robots`](/docs/15/app/api-reference/file-conventions/metadata/robots#static-robotstxt)`.txt`Robots file[`robots`](/docs/15/app/api-reference/file-conventions/metadata/robots#generate-a-robots-file)`.js` `.ts`Generated Robots file
