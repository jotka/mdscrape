...
source: "https://nextjs.org/docs/15/app/getting-started/server-and-client-components"
---
...
[App Router](/docs/15/app)[Getting Started](/docs/15/app/getting-started)Server and Client Components
...
**use client**  
\
Learn how to use the use client directive to render a component on the client.](/docs/15/app/api-reference/directives/use-client)
