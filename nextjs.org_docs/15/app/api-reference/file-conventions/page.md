---
title: "page.js"
source: "https://nextjs.org/docs/15/app/api-reference/file-conventions/page"
---
...
[API Reference](/docs/15/app/api-reference)[File-system conventions](/docs/15/app/api-reference/file-conventions)page.js
...
Example RouteURL`params``app/shop/[slug]/page.js``/shop/1``Promise<{ slug: '1' }>``app/shop/[category]/[item]/page.js``/shop/1/2``Promise<{ category: '1', item: '2' }>``app/shop/[...slug]/page.js``/shop/1/2``Promise<{ slug: ['1', '2'] }>`
...
Example URL`searchParams``/shop?a=1``Promise<{ a: '1' }>``/shop?a=1&b=2``Promise<{ a: '1', b: '2' }>``/shop?a=1&a=2``Promise<{ a: ['1', '2'] }>`
...
VersionChanges`v15.0.0-RC``params` and `searchParams` are now promises. A [codemod](/docs/15/app/guides/upgrading/codemods#150) is available.`v13.0.0``page` introduced.
