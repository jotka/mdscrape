---
title: "sitemap.xml"
source: "https://nextjs.org/docs/15/app/api-reference/file-conventions/metadata/sitemap"
---
...
[File-system conventions](/docs/15/app/api-reference/file-conventions)[Metadata Files](/docs/15/app/api-reference/file-conventions/metadata)sitemap.xml
...
VersionChanges`v14.2.0`Add localizations support.`v13.4.14`Add `changeFrequency` and `priority` attributes to sitemaps.`v13.3.0``sitemap` introduced.
...
**generateSitemaps**  
\
Learn how to use the generateSiteMaps function to create multiple sitemaps for your application.](/docs/15/app/api-reference/functions/generate-sitemaps)
