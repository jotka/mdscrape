...
source: "https://nextjs.org/docs/15/app/api-reference/file-conventions/instrumentation"
---
...
[API Reference](/docs/15/app/api-reference)[File-system conventions](/docs/15/app/api-reference/file-conventions)instrumentation.js
