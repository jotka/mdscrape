---
title: "not-found.js"
source: "https://nextjs.org/docs/15/app/api-reference/file-conventions/not-found"
---
...
[API Reference](/docs/15/app/api-reference)[File-system conventions](/docs/15/app/api-reference/file-conventions)not-found.js
...
VersionChanges`v15.4.0``global-not-found.js` introduced (experimental).`v13.3.0`Root `app/not-found` handles global unmatched URLs.`v13.0.0``not-found` introduced.
