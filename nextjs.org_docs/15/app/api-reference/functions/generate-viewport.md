...
source: "https://nextjs.org/docs/15/app/api-reference/functions/generate-viewport"
---
...
[API Reference](/docs/15/app/api-reference)[Functions](/docs/15/app/api-reference/functions)generateViewport
