---
title: "use client"
source: "https://nextjs.org/docs/15/app/api-reference/directives/use-client"
---
...
[API Reference](/docs/15/app/api-reference)[Directives](/docs/15/app/api-reference/directives)use client
