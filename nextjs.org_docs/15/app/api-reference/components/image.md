...
source: "https://nextjs.org/docs/15/app/api-reference/components/image"
---
...
[API Reference](/docs/15/app/api-reference)[Components](/docs/15/app/api-reference/components)Image Component
