...
\
Use Server-side Rendering to render pages on each request.](/docs/pages/building-your-application/rendering/server-side-rendering)

[**Static Site Generation (SSG)**  
\
Use Static Site Generation (SSG) to pre-render pages at build time.](/docs/pages/building-your-application/rendering/static-site-generation)

[**ISR**  
\
Learn how to create or update static pages at runtime with Incremental Static Regeneration.](/docs/pages/guides/incremental-static-regeneration)
