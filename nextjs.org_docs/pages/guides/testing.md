...
[**Cypress**  
\
Learn how to set up Next.js with Cypress for End-to-End (E2E) and Component Testing.](/docs/pages/guides/testing/cypress)

[**Jest**  
\
Learn how to set up Next.js with Jest for Unit Testing.](/docs/pages/guides/testing/jest)

[**Playwright**  
\
Learn how to set up Next.js with Playwright for End-to-End (E2E) and Integration testing.](/docs/pages/guides/testing/playwright)

[**Vitest**  
\
Learn how to set up Next.js with Vitest and React Testing Library - two popular unit testing libraries.](/docs/pages/guides/testing/vitest)
