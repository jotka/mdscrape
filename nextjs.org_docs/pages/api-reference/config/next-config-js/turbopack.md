...
VersionChanges`16.0.0``turbopack.debugIds` was added.`16.0.0``turbopack.rules.*.condition` was added.`15.3.0``experimental.turbo` is changed to `turbopack`.`13.0.0``experimental.turbo` introduced.
