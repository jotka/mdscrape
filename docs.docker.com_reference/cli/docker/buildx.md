---
title: "docker buildx"
source: "https://docs.docker.com/reference/cli/docker/buildx/"
---
...
DescriptionDocker BuildxUsage`docker buildx`
...
OptionDefaultDescription[`--builder`](#builder)Override the configured builder instance`-D, --debug`Enable debug logging
