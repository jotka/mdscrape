...
OptionDefaultDescription[`-i, --input`](#input)Read from tar archive file, instead of STDIN[`--platform`](#platform)API 1.48+ Load only the given platform variant. Formatted as `os[/arch[/variant]]` (e.g., `linux/amd64`)  
