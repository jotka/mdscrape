...
OptionDefaultDescription`-o, --output`Write to a file, instead of STDOUT[`--platform`](#platform)API 1.48+ Save only the given platform variant. Formatted as `os[/arch[/variant]]` (e.g., `linux/amd64`)
