...
DescriptionInspect a build recordUsage`docker buildx history inspect [OPTIONS] [REF]`
...
OptionDefaultDescription[`--format`](#format)`pretty`Format the output
...
CommandDescription[`docker buildx history inspect attachment`](https://docs.docker.com/reference/cli/docker/buildx/history/inspect/attachment/)Inspect a build record attachment
