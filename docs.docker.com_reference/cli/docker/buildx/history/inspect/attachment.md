...
DescriptionInspect a build record attachmentUsage`docker buildx history inspect attachment [OPTIONS] [REF [DIGEST]]`
...
OptionDefaultDescription[`--platform`](#platform)Platform of attachment[`--type`](#type)Type of attachment
