...
DescriptionInspect changes to files or directories on a container's filesystemUsage`docker container diff CONTAINER`Aliases
...
SymbolDescription`A`A file or directory was added`D`A file or directory was deleted`C`A file or directory was changed
