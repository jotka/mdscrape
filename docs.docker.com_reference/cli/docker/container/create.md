...
DescriptionCreate a new containerUsage`docker container create [OPTIONS] IMAGE [COMMAND] [ARG...]`Aliases
...
OptionDefaultDescription`--add-host`Add a custom host-to-IP mapping (host:ip)`--annotation`API 1.43+ Add an annotation to the container (passed through to the OCI runtime)  
