...
DescriptionShow docker disk usageUsage`docker system df [OPTIONS]`
...
Refer to [https://docs.docker.com/go/formatting/](https://docs.docker.com/go/formatting/) for more information about formatting output with templates`-v, --verbose`Show detailed information on space usage
