...
Requires: Docker Compose [2.36.0](https://docs.docker.com/compose/releases/release-notes/#2360) and later
...
- `image`: Configures additional image options:
  ...
  - `subpath`: Path inside the source image to mount instead of the image root. Available in [Docker Compose version 2.35.0](https://docs.docker.com/compose/releases/release-notes/#2350)
